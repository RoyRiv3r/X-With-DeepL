...
document.addEventListener("DOMContentLoaded", /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
  var apiKeyInput, targetLanguageSelect, formalitySelect, splitSentencesCheckbox, preserveFormattingCheckbox, removeTwitterTranslateButtonCheckbox, autoTranslateInStatusCheckbox, messageDiv, parseBoolean, apiKey, targetLanguage, formality, splitSentences, preserveFormatting, removeTwitterTranslateButton, autoTranslateInStatus, saveSetting, optionsForm;
  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      case 0:
        saveSetting = function _saveSetting(key, value) {
          (0,_utils_storage_js__WEBPACK_IMPORTED_MODULE_0__.setSetting)(key, value);
        ...
        parseBoolean = function _parseBoolean(value) {
        ...
        splitSentencesCheckbox = document.getElementById("split-sentences");
        preserveFormattingCheckbox = document.getElementById("preserve-formatting");
        removeTwitterTranslateButtonCheckbox = document.getElementById("remove-twitter-translate-button");
        autoTranslateInStatusCheckbox = document.getElementById("auto-translate-in-status");
        messageDiv = document.getElementById("message"); // Helper function to parse stored values to booleans
        _context2.next = 12;
      ...
      case 43:
        ...
        if (preserveFormattingCheckbox) preserveFormattingCheckbox.checked = preserveFormatting;
        if (removeTwitterTranslateButtonCheckbox) removeTwitterTranslateButtonCheckbox.checked = removeTwitterTranslateButton;
        if (autoTranslateInStatusCheckbox) autoTranslateInStatusCheckbox.checked = autoTranslateInStatus;

        // Save settings immediately when checkboxes change

        if (splitSentencesCheckbox) {
          splitSentencesCheckbox.addEventListener("change", function (e) {
            saveSetting("split_sentences", e.target.checked);
          });
        }
        if (preserveFormattingCheckbox) {
          preserveFormattingCheckbox.addEventListener("change", function (e) {
            saveSetting("preserve_formatting", e.target.checked);
          });
        }
        if (removeTwitterTranslateButtonCheckbox) {
          removeTwitterTranslateButtonCheckbox.addEventListener("change", function (e) {
            saveSetting("remove_twitter_translate_button", e.target.checked);
          });
        }
        if (autoTranslateInStatusCheckbox) {
          autoTranslateInStatusCheckbox.addEventListener("change", function (e) {
        ...
        if (optionsForm) {
          optionsForm.addEventListener("submit", /*#__PURE__*/function () {
              ...
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    e.preventDefault();
                    _context.next = 3;
                    return (0,_utils_storage_js__WEBPACK_IMPORTED_MODULE_0__.setSetting)("api_key", apiKeyInput.value);
                  case 3:
                    _context.next = 5;
                    return (0,_utils_storage_js__WEBPACK_IMPORTED_MODULE_0__.setSetting)("target_language", targetLanguageSelect.value);
                  case 5:
                    _context.next = 7;
                    return (0,_utils_storage_js__WEBPACK_IMPORTED_MODULE_0__.setSetting)("formality", formalitySelect.value);
                  case 7:
